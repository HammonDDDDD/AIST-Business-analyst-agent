# Contributing to AIST-Business-analyst-agent

We welcome you to [check the existing issues](https://github.com/HammonDDDDD/AIST-Business-analyst-agent/issues) for bugs or enhancements to work on.
If you have an idea for an extension to AIST-Business-analyst-agent, please [file a new issue](https://github.com/HammonDDDDD/AIST-Business-analyst-agent/issues/new) so we can discuss it.

Make sure to familiarize yourself with the project layout before making any major contributions.

## How to contribute

1. Fork the [project repository](https://github.com/HammonDDDDD/AIST-Business-analyst-agent/): click on the 'Fork' button near the top of the page. This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

   ```bash
   git clone git@github.com:YourUsername/AIST-Business-analyst-agent.git
   ```
...
Finally, go to the web page of your fork of the AIST-Business-analyst-agent repo, and click
...
If your contribution changes AIST-Business-analyst-agent in any way:
